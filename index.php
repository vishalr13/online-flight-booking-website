...
.intro_background{top:-128px;left:0;width:100%;height:10px;background-repeat:no-repeat;background-size:cover;background-position:center center}
...
<div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:200px;">
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<div class="text-light text-center">&copy; <?php echo date('Y')?> - Developed By CSE<br><br></div>
	<!-- <p>----------</p> -->
